...
#pragma ident	"@(#)prom_vercheck.c	1.10	98/06/26 SMI"
...
static struct obp_rev_table {
	...
	{"SUNW,525-1410", "OBP 3.11.1 1997/12/03 15:55"},  /* neutron */
	{"SUNW,525-1448", "OBP 3.11.1 1997/12/03 16:43"},  /* neutron+ */
	{"SUNW,525-1411", "OBP 3.11.1 1997/12/03 15:44"},  /* electron */
	{"SUNW,525-1681", "OBP 3.11.1 1997/12/03 15:49"},  /* electron 143 */
	{"SUNW,525-1662", "OBP 3.11.1 1997/12/03 15:53"},  /* electron 200 */
...
visit(dnode_t node)
{
	 ...
	 */
	if (prom_getproplen(node, "name") != sizeof (flashprom))
		return ((dnode_t)0);
	(void) prom_getprop(node, "name", model);
