...
#pragma ident	"@(#)FNSP_HierContext.hh	1.1	96/03/31 SMI"
...
protected:
	...
	virtual FN_ref *resolve(const FN_string &name, FN_status_asvc&);
...
public:
	...
	virtual FN_attribute *a_attr_get(const FN_string &,
	    ...
	    FN_status_asvc&);
	virtual int a_attr_modify(const FN_string &, unsigned int,
	...
	virtual int a_attr_multi_modify(const FN_string &,
	    ...
	    unsigned int, FN_attrmodlist **, FN_status_asvc&);
	...
	virtual int a_rename_nns(const FN_string &,
	    const FN_composite_name &newn, unsigned BindFlags, FN_status_asvc&);
