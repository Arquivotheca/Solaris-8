...
#ifndef	_FNSP_PRINTEROBJECT_HH
#define	_FNSP_PRINTEROBJECT_HH

#pragma ident	"@(#)FNSP_PrinterObject.hh	1.1	96/03/31 SMI"

#include <xfn/fn_spi.hh>
#include "FNSP_Impl.hh"

class FNSP_PrinterObject : public FN_ctx_csvc_strong {
protected:
	FN_ref *my_reference;
	FNSP_Impl *ns_impl;
...
public:
	...
	virtual FN_attrset* c_get_syntax_attrs_nns(
	    const FN_string &name, FN_status_csvc&);
