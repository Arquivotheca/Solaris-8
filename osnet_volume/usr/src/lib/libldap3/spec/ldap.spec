...
# All rights reserved.
#
#pragma ident	"@(#)ldap.spec	1.1	99/10/06 SMI"
#
...
function	ber_flush
include		<lber.h>
declaration	int ber_flush(Sockbuf *sb, BerElement *ber, int freeit)
version		SUNW_1.2
end
...
include		<lber.h>
declaration	unsigned int ber_get_next(Sockbuf *sb, unsigned int *len, \
			BerElement *ber)
version		SUNW_1.2
end
...
include		<lber.h>, <ldap.h>
declaration	void close_ldap_connection(Sockbuf *sb)
version		SUNW_1.1
end		
...
include		<lber.h>, <ldap.h>
declaration	int open_ldap_connection(LDAP *ld, Sockbuf *sb, \
			char *host, int defport, char **krbinstancep, \
			int async)
version		SUNW_1.1
end		
