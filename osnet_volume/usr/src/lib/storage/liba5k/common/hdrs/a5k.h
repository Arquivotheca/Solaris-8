...
#pragma ident	"@(#)a5k.h	1.7	99/08/27 SMI"
...
int	l_chk_null_wwn(Path_struct *, char *, L_state *, int);
int	l_convert_name(char *, char **, struct path_struct **, int);
int	l_dev_pwr_up_down(char *, struct path_struct *, int, int, int);
int	l_device_present(char *, int, sf_al_map_t *, int, char **);
int	l_download(char *, char *, int, int);
int	l_duplicate_names(Box_list *, char *, char *, int);
int	l_encl_status_page_funcs(int, char *, int, char *,
	struct l_state_struct  *, int, int, int);
int	l_format_ifp_status_msg(char *, int, int);
int	l_format_fc_status_msg(char *, int, int);
void	l_free_box_list(struct box_list_struct **);
int	l_free_lstate(L_state **);
int	l_get_allses(char *, struct box_list_struct *, struct dlist **, int);
int	l_get_box_list(struct box_list_struct **, int);
int	l_get_disk_element_index(struct l_state_struct *, int *, int *);
int	l_get_disk_port_status(char *, struct l_disk_state_struct *, int,
	int);
int	l_get_disk_status(char *, struct l_disk_state_struct *, WWN_list *,
	int);
void	l_get_drive_name(char *, int, int, char *);
int	l_get_envsen(char *, uchar_t *, int, int);
int	l_get_envsen_page(int, uchar_t *, int, uchar_t, int);
int	l_get_ib_status(char *, struct l_state_struct *, int);
int	l_get_individual_state(char *, struct l_disk_state_struct *,
	Ib_state *, int, struct box_list_struct *, struct wwn_list_struct *,
	int);
int	l_get_port(char *, int *, int);
int	l_get_ses_path(char *, char *, sf_al_map_t *, int);
int	l_get_slot(struct path_struct *, L_state *, int);
int	l_get_status(char *, struct l_state_struct *, int);
int	l_led(struct path_struct *, int, struct device_element *, int);
int	l_make_node(char *, int, char *, sf_al_map_t *, int);
int	l_new_name(char *, char *);
int	l_offline_photon(struct hotplug_disk_list *, struct wwn_list_struct *,
	int, int);
int	l_pho_pwr_up_down(char *, char *, int, int, int);
