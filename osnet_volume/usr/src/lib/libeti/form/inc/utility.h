...
#pragma ident	"@(#)utility.h	1.5	97/09/11 SMI"	/* SVr4.0 1.8	*/
...
extern int	__execute(char *, char *);
extern int	__advance(char *, char *);
extern int	__xpop(int);
extern int	__xpush(int, char *);
extern int	__getrnge(int *, int *, char *);
extern int	__cclass(char *, char, int);
extern int	__size(char *);
extern int	__rpush(char *);
extern int	__rpop(void);

extern char *	regcmp(char *, char *, char *, char *, char *, char *, char *,
			char *, char *, char *);
extern char *	regcmp_p2(char *, char *);

extern char *	regex(char *, char *, char *, char *, char *, char *, char *);
extern char *	regex_p2(char *, char *);
