...
#pragma ident	"@(#)regex.c	1.5	97/09/17 SMI"	/* SVr4.0 1.2	*/
...
char *
regex_p2(char *addrc, char *addr1)
{
	return (regex(addrc, addr1, (char *) NULL, (char *) NULL,
		(char *) NULL, (char *) NULL, (char *) NULL));
}

char *
regex(char *addrc, char *addrl, char *a1, char *a2,
