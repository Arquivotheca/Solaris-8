/*
 * ident	"@(#)ServiceStoreInMemory.java	1.3	99/10/08 SMI"
 *
...
//  SCCS Status:      @(#)ServiceStoreInMemory.java	1.3	10/08/99
...
class ServiceStoreInMemory extends Object implements ServiceStore {
	...
	ServiceRecordInMemory(ServiceURL surl, Vector alist,
	    ...
	    Assert.nonNullParameter(nscopes, "nscope");
	...
	// Deregister the URL for all locales.

	deregisterInternal(url, scopes, null);
	...
	Assert.assert(en.hasMoreElements(),
	...
	while (en.hasMoreElements()) {
	    ...
	    Assert.assert(een.hasMoreElements(),
	...
	Assert.assert(langLevel.get(lang) == null,
		      "ssim_url_lang_botch",
		      new Object[] {lang,
					url,
					scope});
	...
	Assert.assert(localeLevel != null,
