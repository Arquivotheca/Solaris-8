...
#pragma	ident	"@(#)patlocal.h 1.17	97/02/06  SMI"
...
#define	__wcuniqcollwgt(wc)	/* unique collating weight */		\
	(phdl->co_coltbl[MAX_NORDS][(wc)])

#define	MBTOWC_NATIVE(pwc, s, n)	(METHOD_NATIVE(__lc_charmap, mbtowc)\
				(__lc_charmap, (pwc), (s), (n)))
#define	WCTOMB_NATIVE(s, pwc)		(METHOD_NATIVE(__lc_charmap, wctomb)\
				(__lc_charmap, (s), (pwc)))
#define	TOWLOWER_NATIVE(wc)		(METHOD_NATIVE(__lc_ctype, towlower)\
				(__lc_ctype, (wc)))
#define	TOWUPPER_NATIVE(wc)		(METHOD_NATIVE(__lc_ctype, towlower)\
				(__lc_ctype, (wc)))
#define	ISWCTYPE_NATIVE(wc, n) 		(METHOD_NATIVE(__lc_ctype, iswctype)\
				(__lc_ctype, (wc), (n)))
