...
.ident	"@(#)strncpy.s	1.14	98/12/18 SMI"
...
2:	inc	4, DEST
.w4str:	deccc	4, CNT
	bleu,a,pn %xcc, .pad_trunc	! if less than 4 bytes left go 1 by 1
	inc	4, CNT			! delay slot, original value
...
.pad_trunc:
	deccc	CNT
	bcs,pn	%xcc, 2f	! all done now. May have truncated
	nop
