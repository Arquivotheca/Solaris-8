...
! Note: we use %sp+STACK_BIAS+0x88 (shadow area of %o0) for temporary space

.ident	"@(#)_Q_get_rp_rd.s	1.4	96/12/20 SMI"
...
#include <sys/asm_linkage.h>
	...
	st	%o1,[%sp+STACK_BIAS+ARGPUSH]
	ld	[%sp+STACK_BIAS+ARGPUSH],%fsr
	and	%o0,%o4,%o0
	srl	%o0,30,%o0
	retl
	add     %sp,SA(MINFRAME),%sp
