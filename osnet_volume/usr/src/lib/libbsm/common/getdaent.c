#ifndef lint
static char	sccsid[] = "@(#)getdaent.c 1.5 97/10/29 SMI";
#endif
...
_daalloc()
{
	...
	if (_da == 0) {
		_da = (struct _dabuff *)
		calloc((unsigned) 1, (unsigned) sizeof (*__dabuff));
		if (_da == 0)
			return (0);
