#pragma ident	"@(#)server_internal.h	1.1	99/07/18 SMI"
 ...
 *
 * $Header: /afs/athena.mit.edu/astaff/project/krbdev/.cvsroot/src/lib/kadm5/server_internal.h,v 1.27 1996/10/21 20:29:58 bjaspan Exp $
 */
