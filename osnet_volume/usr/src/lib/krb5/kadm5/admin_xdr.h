#pragma ident	"@(#)admin_xdr.h	1.1	99/07/18 SMI"
 ...
 *
 * $Header: /afs/athena.mit.edu/astaff/project/krbdev/.cvsroot/src/lib/kadm5/admin_xdr.h,v 1.5 1996/07/22 20:35:33 marc Exp $
 * 
 * $Log: admin_xdr.h,v $
