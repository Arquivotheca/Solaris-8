#pragma ident "@(#)llcsetup.c 1.20	96/03/07 SMI"
...
unsigned char	myNodeAddr[6];
char	enabmulti[DL_ENABMULTI_REQ_SIZE+10];
union	DL_primitives *enabp = (union DL_primitives *)enabmulti;
