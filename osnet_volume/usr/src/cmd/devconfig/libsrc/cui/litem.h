#pragma ident "@(#)litem.h   1.3     92/11/25 SMI"
...
//
//	$RCSfile: litem.h $ $Revision: 1.5 $ $Date: 1992/09/12 15:18:12 $
//=============================================================================
...
class ListItem : public Item
{
    ...
    public:
		...
		ListItem(char *Name, Widget * = NULL, CUI_Resource * = NULL,
				 CUI_WidgetId id = CUI_LITEM_ID);
        int realize(void);
		...
		virtual int isKindOf(CUI_WidgetId type)
					{ return(type == CUI_LITEM_ID || Item::isKindOf(type)); }
};
#define NULL_LITEM (ListItem *)0
