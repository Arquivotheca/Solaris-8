#pragma ident	"@(#)sas_tables.c	1.4	93/06/04 SMI"
...
struct bcccMnemonicTableStruct *bcccMnemonicTable;

static
makeBcccMnemonicTable()
{
	bcccMnemonicTable = (struct bcccMnemonicTableStruct *)
		makeTable(opcodeTable, sizeof(opcodeTable[0]),
		bcccMnCheckRecord,
		bcccMnExtractKey,
		bcccMnTransRecord,
		sizeof(bcccMnemonicTable[0]),
		pow2(IFW_COND));
}

static
printBcccMnemonicTable()
{
	int i;

	printf("Bccc Mnemonic Table\n");
	printf("COND		MNEMONIC\n");

	for(i = 0; i < pow2(IFW_COND); ++i)
		printf("0x%x		%s\n",
			i, (bcccMnemonicTable + i)->mnemonic);
}

static
bcccMnCheckRecord(rec)
struct opcodeTableStruct *rec;
{
	if(rec->o_type == NONE)return(LAST_RECORD);
	if(rec->o_mnemonic != NONE && rec->o_switchIndex == BCCC &&
		rec->o_type == OT_F2)
		return(INTERESTING_RECORD);
	return(BORING_RECORD);
}
...
static
bcccMnTransRecord(rec, newPlace)
struct opcodeTableStruct *rec;
struct bcccMnemonicTableStruct *newPlace;
{
	newPlace->mnemonic = rec->o_mnemonic;
}
...
CBN,		OT_CC,	0x0,	NONE,	NONE,	NONE,
CB3,		OT_CC,	0x7,	NONE,	NONE,	NONE,
CB2,		OT_CC,	0x6,	NONE,	NONE,	NONE,
CB23,		OT_CC,	0x5,	NONE,	NONE,	NONE,
CB1,		OT_CC,	0x4,	NONE,	NONE,	NONE,
CB13,		OT_CC,	0x3,	NONE,	NONE,	NONE,
CB12,		OT_CC,	0x2,	NONE,	NONE,	NONE,
CB123,		OT_CC,	0x1,	NONE,	NONE,	NONE,
CB0,		OT_CC,	0x9,	NONE,	NONE,	NONE,
CB03,		OT_CC,	0xa,	NONE,	NONE,	NONE,
CB02,		OT_CC,	0xb,	NONE,	NONE,	NONE,
CB023,		OT_CC,	0xc,	NONE,	NONE,	NONE,
CB01,		OT_CC,	0xd,	NONE,	NONE,	NONE,
CB013,		OT_CC,	0xe,	NONE,	NONE,	NONE,
CB012,		OT_CC,	0xf,	NONE,	NONE,	NONE,
CBA,		OT_CC,	0x8,	NONE,	NONE,	NONE,
...
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0x0,	"cbn",
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0x7,	"cb3",
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0x6,	"cb2",
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0x5,	"cb23",
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0x4,	"cb1",
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0x3,	"cb13",
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0x2,	"cb12",
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0x1,	"cb123",
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0x9,	"cb0",
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0xa,	"cb03",
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0xb,	"cb02",
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0xc,	"cb023",
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0xd,	"cb01",
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0xe,	"cb013",
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0xf,	"cb012",
BCCC,		OT_F2,	0,  SR_CBCC_OP, 0x8,	"cba",
...
ALS,		OT_F3,	3,	3<<IFW_OP3 | 0x0d,	NONE,	"ldstub",
AALS,		OT_F3,	3,	3<<IFW_OP3 | 0x1d,	NONE,	"ldstuba",
...
/*	Newly added integer multiply instructions for version8.0	*/
UMULcc,		OT_F3,	2,	2<<IFW_OP3 | 0x1a,	NONE,	"umulcc",
SMULcc,		OT_F3,	2,	2<<IFW_OP3 | 0x1b,	NONE,	"smulcc",
UMUL,		OT_F3,	2,	2<<IFW_OP3 | 0x0a,	NONE,	"umul",
SMUL,		OT_F3,	2,	2<<IFW_OP3 | 0x0b,	NONE,	"smul",

/*	Newly added integer divide instructions for version8.0	*/
UDIVcc,		OT_F3,	2,	2<<IFW_OP3 | 0x1e,	NONE,	"udivcc",
SDIVcc,		OT_F3,	2,	2<<IFW_OP3 | 0x1f,	NONE,	"sdivcc",
UDIV,		OT_F3,	2,	2<<IFW_OP3 | 0x0e,	NONE,	"udiv",
SDIV,		OT_F3,	2,	2<<IFW_OP3 | 0x0f,	NONE,	"sdiv",
...
JUMP,		OT_F3,	2,	2<<IFW_OP3 | 0x38,	NONE,	"jmpl",
...
/* V8 instruction		*/
RDASR,		OT_F3,	2,	2<<IFW_OP3 | 0x28,	NONE,	"rd",

/*	version 8, store barrier instruction */
STBAR,          OT_F3,  2,      2<<IFW_OP3 | 0x28,      NONE,   "stbar",
...
/*	V8.0 instruction wrasr	*/
WRASR,		OT_F3,	2,	2<<IFW_OP3 | 0x30,	NONE,	"wr",
...
FLUSH,		OT_F3,	2,	2<<IFW_OP3 | 0x3b,	NONE,	"flush",
...
FCVTie,		OT_FOP,	2,	0x34,	0xcc,	"fitoq",
...
FCVTeiz,	OT_FOP,	2,	0x34,	0xd3,	"fqtoi",
...
FCVTse,		OT_FOP,	2,	0x34,	0xcd,	"fstoq",
FCVTds,		OT_FOP,	2,	0x34,	0xc6,	"fdtos",
FCVTde,		OT_FOP,	2,	0x34,	0xce,	"fdtoq",
FCVTes,		OT_FOP,	2,	0x34,	0xc7,	"fqtos",
FCVTed,		OT_FOP,	2,	0x34,	0xcb,	"fqtod",
