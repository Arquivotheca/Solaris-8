#pragma ident	"@(#)sas_incs.h	1.4	93/06/04 SMI"
/*
...
/* bccc mnemonic table */
struct bcccMnemonicTableStruct { char *mnemonic; };
extern struct bcccMnemonicTableStruct *bcccMnemonicTable;
				/* indexed with opx2 = cond */
...
extern bcccMnCheckRecord();
extern bcccMnExtractKey();
extern bcccMnTransRecord();
...
#define OT_CC		8	/* Coprocessor condition code field */
...
/* 	SPARC version 8 additions below */

/*	Instruction Cache flush renamed FLUSH */
#define FLUSH		147
