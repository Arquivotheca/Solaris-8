...
/*
 * mike_s@Sun.COM 8/4/1999 - fully prototyped shell_builtin_compare.
 */
#include <config.h>
...
static int
shell_builtin_compare (const void *arg1, const void *arg2)
{
  int result;
  struct builtin *sbp1 = (struct builtin *)arg1;
  struct builtin *sbp2 = (struct builtin *)arg2;
