...
#pragma ident	"@(#)dis.h	1.2	99/11/19 SMI"
...
#define		NCPS	9	/* number of chars per symbol	*/
...
#define	XADDB	54	/* for xaddb */
#define	MMXL	55	/* for MMX load */
#define	MMXS	56	/* for MMX store */
#define	MMXSH	57	/* for MMX shift */
