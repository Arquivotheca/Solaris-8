...
# All rights reserved.
#
#ident	"@(#)mkmodules.sh	1.1	99/08/11 SMI"
...
# to ``mdb -R'' or by mdb's auto-detect code (when I get around to writing it).
...
s998_fcs) BLDID=0x2721 ;;
  ...
  s899_*) BLDID=0x27FF ;;
 s1199_*) BLDID=0x27FF ;;
   s28_*) BLDID=0x28`basename $INCROOT | sed 's/s28_//' | tr -cd '[0-9]'` ;;
