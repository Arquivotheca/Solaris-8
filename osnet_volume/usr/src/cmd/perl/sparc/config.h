 ...
 */
#define ARCHLIB "/usr/perl5/5.00503/sun4-solaris"		/**/
#define ARCHLIB_EXP "/usr/perl5/5.00503/sun4-solaris"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/perl5/site_perl/5.005/sun4-solaris"		/**/
#define SITEARCH_EXP "/usr/perl5/site_perl/5.005/sun4-solaris"		/**/
