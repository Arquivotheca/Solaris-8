/*
 * Copyright (c) 1987,1991,1998 by Sun Microsystems, Inc.
 * All rights reserved.
 */

#pragma ident	"@(#)syncloop.c	1.10	98/02/12 SMI"
...
main(int argc, char **argv)
{
	...
	(void) sprintf(dnambuf, "/dev/%s", portname);
	...
	*cp = '\0';	/* drop number, leaving name of clone device. */
	(void) sprintf(cnambuf, "/dev/%s", portname);
