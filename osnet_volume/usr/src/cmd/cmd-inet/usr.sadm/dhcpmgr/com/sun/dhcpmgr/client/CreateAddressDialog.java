/*
 * @(#)CreateAddressDialog.java	1.8	99/08/05 SMI
 *
...
public class CreateAddressDialog extends JDialog
	...
	JLabel l = new JLabel(ResourceStrings.getString("ip_address_label"),
	...
	l = new JLabel(ResourceStrings.getString("hostname_label"),
	    SwingConstants.RIGHT);
	++c.gridy;
	c.gridx = 0;
	bag.setConstraints(l, c);
	...
	l = new JLabel(ResourceStrings.getString("owning_server_label"),
	    SwingConstants.RIGHT);
	++c.gridy;
	c.gridx = 0;
	bag.setConstraints(l, c);
	...
	l = new JLabel(ResourceStrings.getString("config_macro_label"),
	    SwingConstants.RIGHT);
	++c.gridy;
	c.gridx = 0;
	bag.setConstraints(l, c);
	...
	// Comment
	l = new JLabel(ResourceStrings.getString("comment_label"),
	    SwingConstants.RIGHT);
	++c.gridy;
	c.gridx = 0;
	bag.setConstraints(l, c);
	...
	l = new JLabel(ResourceStrings.getString("client_id_label"));
	idPanel.add(l);
	...
	l = new JLabel(ResourceStrings.getString("leased_label"));
	++c.gridx;
	c.weightx = 1.0;
	bag.setConstraints(l, c);
	leasePanel.add(l);
	...
	l = new JLabel(ResourceStrings.getString("permanent_label"));
	++c.gridx;
	c.weightx = 1.0;
	bag.setConstraints(l, c);
	leasePanel.add(l);
