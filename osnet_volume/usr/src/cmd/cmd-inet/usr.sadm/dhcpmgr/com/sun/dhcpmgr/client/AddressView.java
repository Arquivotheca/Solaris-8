/*
 * @(#)AddressView.java	1.11	99/09/07 SMI
 *
...
public class AddressView implements View {
	...
	public void load() {
		...
		ints[0] = new Integer(len);
	        MainFrame.setStatusText(
		    MessageFormat.format(
		    ResourceStrings.getString("networks_loaded"), ints));
	    }
	}
	...
	public void finished() {
	    ...
	    Integer [] ints = new Integer[1];
	    ints[0] = new Integer(addressTableModel.getRowCount());
	    MainFrame.setStatusText(
		MessageFormat.format(
		ResourceStrings.getString("address_status_message"), ints));
	...
	networkPanel.add(new JLabel(ResourceStrings.getString("network")),
	    BorderLayout.NORTH);
	...
	// Create menu items
	showAddresses = new JCheckBoxMenuItem(
	    ResourceStrings.getString("show_addresses"), false);
	...
	addNet = new JMenuItem(ResourceStrings.getString("add_network"));
	...
	deleteNets = new JMenuItem(
	    ResourceStrings.getString("delete_networks"));
	...
	addAddrs = new JMenuItem(ResourceStrings.getString("add_addresses"));
	...
	releaseAddrs = new JMenuItem(
	    ResourceStrings.getString("release_addresses"));
	...
	addressHelp = new JMenuItem(
	    ResourceStrings.getString("on_addresses_item"));
