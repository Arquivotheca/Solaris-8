#!/bin/sh
#
# Copyright 1992-1999 Sun Microsystems Inc.
#
#pragma ident	"@(#)nissetup.sh	1.20	99/06/03 SMI"
#
...
then
	...
	if nistbladm -D group=admin.$D:$A -c exec_attr_tbl name=S,$CA policy=,$CA type=,$CA res1=,$CA res2=,$CA id=S,$CA attr=,$CA exec_attr.org_dir.$D
	then
