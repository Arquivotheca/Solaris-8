...
#pragma ident	"@(#)nisaddent.c	1.55	99/09/20 SMI"
...
genent_exec_attr(line, cback, udata)
	...
	void *udata;
{
	int keycol[EXECATTR_DB_NKEYCOL] = {EXECATTR_KEYCOL0, EXECATTR_KEYCOL1};
	...
	return (genent_attr(line, cback, udata, NSS_DBNAM_EXECATTR,
	    EXECATTR_DB_NCOL, cnames, EXECATTR_DB_NKEYCOL, keycol));
}
...
genent_user_attr(line, cback, udata)
	...
	void *udata;
{
	int keycol[USERATTR_DB_NKEYCOL] = {USERATTR_KEYCOL0, USERATTR_KEYCOL1};
	...
	return (genent_attr(line, cback, udata, NSS_DBNAM_USERATTR,
	    USERATTR_DB_NCOL, cnames, USERATTR_DB_NKEYCOL, keycol));
}
...
struct ttypelist_t ttypelist[] = {
	...
	{ "exec_attr", "exec_attr.byname", "exec_attr.org_dir", "exec_attr_tbl",
	    0, 0, 1, ":",
	    dbmniskey, nisdbmkey, filedbmkey, genent_exec_attr,
	    dump_exec_attr, 0,
	    filedbmline_comment, filetodbm, fetchdbm,
	    printfkeystr_0 },
	...
	{ "user_attr", "user_attr.byname", "user_attr.org_dir", "user_attr_tbl",
	    0, 0, 1, ":",
	    dbmniskey, nisdbmkey, filedbmkey, genent_user_attr,
	    dump_user_attr, 0,
	    filedbmline_comment, filetodbm, fetchdbm,
	    printfkeystr_0 },
