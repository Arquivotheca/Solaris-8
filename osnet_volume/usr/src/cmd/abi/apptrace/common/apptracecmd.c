...
#pragma ident	"@(#)apptracecmd.c	1.2	99/09/20 SMI"
...
static char *APPTRACE_INTERCEPTORS =
	"APPTRACE_INTERCEPTORS=/usr/lib/abi/interceptors.so.1";
static char *APPTRACE_INTERCEPTORS64 =
	"APPTRACE_INTERCEPTORS64=/usr/lib/abi/sparcv9/interceptors.so.1";
...
#define	TEXT_DOMAIN "SYS_TEST"	/* Use this only if it weren't */
	...
	(void) putenv(APPTRACE_INTERCEPTORS);
	(void) putenv(APPTRACE_INTERCEPTORS64);
