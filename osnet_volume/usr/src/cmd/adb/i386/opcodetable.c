...
#ident "@(#)opcodetable.c	1.7	97/07/18 SMI"
 ...
 * the following array specifies the registers for the different
 * addressing modes.
...
/*  [4]  */	{"shlb",TERM,Mv,0},	{"shrb",TERM,Mv,0},	{"salb",TERM,Mv,0},	{"sarb",TERM,Mv,0},
};
...
/*  [4]  */	{"shl",TERM,MvI,1},	{"shr",TERM,MvI,1},	{"sal",TERM,MvI,1},		{"sar",TERM,MvI,1},
};
...
/*  [4]  */	{"shl",TERM,Mv,1},	{"shr",TERM,Mv,1},	{"sal",TERM,Mv,1},		{"sar",TERM,Mv,1},
};
...
/*  [0]  */	{"rol",TERM,Mv,1},	{"ror",TERM,Mv,1},	{"rcl",TERM,Mv,1},	{"rcr",TERM,Mv,1},
/*  [4]  */	{"shl",TERM,Mv,1},	{"shr",TERM,Mv,1},	{"salb",TERM,Mv,1},		{"sar",TERM,Mv,1},
};
...
/*  [0]  */	{"testb",TERM,IMw,0},	{"testb",TERM,IMw,0},		{"notb",TERM,Mw,0},	{"negb",TERM,Mw,0},
...
/*  [0]  */	{"test",TERM,IMw,1},	{"test",TERM,IMw,1},		{"not",TERM,Mw,1},	{"neg",TERM,Mw,1},
...
/*  [0,4]  */	{"ftst",TERM,GO_ON,0},	{"fxam",TERM,GO_ON,0},	{"ftstp",TERM,GO_ON,0},		INVALID,
...
/*  [2,4]  */	{"fxtract",TERM,GO_ON,0},{"fpreml",TERM,GO_ON,0},		{"fdecstp",TERM,GO_ON,0},{"fincstp",TERM,GO_ON,0},
...
/*  [0]  */	{"feni",TERM,GO_ON,0},		{"fdisi",TERM,GO_ON,0},		{"fnclex",TERM,GO_ON,0},{"fninit",TERM,GO_ON,0},
/*  [4]  */	{"fsetpm",TERM,GO_ON,0},{"frstpm",TERM,GO_ON,0},		INVALID,		INVALID,
};
