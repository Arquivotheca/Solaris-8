...
#pragma ident	"@(#)sparc.h	1.16	99/03/31 SMI"
...
#define	Reg_Y		32
#define	Reg_TSTATE	33
#define	Reg_PSR		Reg_TSTATE
#define	Reg_WIM		34
#define	Reg_TBA		35
#define	Reg_TBR		Reg_TBA
#define	Reg_PC		36
#define	Reg_NPC		37
#define	LAST_NREG	Reg_NPC	/* last normal (non-Floating) register */

#define	Reg_CWP		38
#define	Reg_OTHERWIN	39
#define	Reg_CLEANWIN	40
#define	Reg_CANSAVE	41
#define	Reg_CANRESTORE	42
#define	Reg_WSTATE	43
#define	Reg_TT		44
#define	Reg_PIL		45

#define	Reg_FSR		46	/* FPU status */
#define	Reg_FQ		47	/* FPU queue */
...
char	*regnames[]
	...
	"y",		"tstate",	"wim",		"tba",
	"pc",		"npc",		"cwp",		"otherwin",
	"cleanwin",	"cansave",	"canrestore",	"wstate",
	"tt",		"pil",
...
#ifdef REGNAMESINIT
#define	NALTREGISTERS	(sizeof (altregname) / sizeof (altregname[0]))
altregname[] = {
	"psr", Reg_PSR,
	"tbr", Reg_TBR,
	"i6", Reg_I6,
...
#ifndef _ASM
struct stackpos {
	ulong_t	k_pc;		/* where we are in this proc */
	ulong_t	k_fp;		/* this proc's frame pointer */
	uint_t	k_nargs;	/* This we can't figure out on sparc */
	ulong_t	k_entry;	/* this proc's entry point */
	ulong_t	k_caller;	/* PC of the call that called us */
	uint_t	k_level;	/* stack level; 0 is most recent frame */
...
#define	K_ONSTACK	16	/* assume all registers are on the stack */
...
#define	SR_RDPR_OP		0x2A
#define	SR_WRPR_OP		0x32
#define	SR_JUMP_OP		0x38
#define	SR_TICC_OP		0x3A

/* Register number indicating PSTATE in RDPR and WRPR instructions */
#define	SR_PSTATE_PR		0x06
