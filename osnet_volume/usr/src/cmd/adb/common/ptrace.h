...
#pragma ident	"@(#)ptrace.h	1.1	97/11/13 SMI"
...
#define	PTRACE_X86IO		32	/* watchpoint on x86 I/O addr */
#define PTRACE_READPHYS		33	/* 33, read physical memory */
#define PTRACE_WRITEPHYS	34	/* 34, write physical memory */
