...
#ifndef _SYS_CMOSRAM_H
#define	_SYS_CMOSRAM_H

#pragma ident   "@(#)cmosram.h 1.1     96/04/02 SMI"

/*
 * This file was derived from the kernel file cram.h, but
 * included to much cruft to allow the standalones to
