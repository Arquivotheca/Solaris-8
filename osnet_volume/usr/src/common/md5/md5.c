...
#pragma ident	"@(#)md5.c	1.6	99/07/02 SMI"
 ...
 *
 * Right now, i386 is the CISC exception.
...
void
MD5Update(MD5_CTX *ctx, unsigned char *input, unsigned int input_len)
{
...
#ifndef __i386
/*
 * The i386 doesn't require aligned 4-byte loads.  The symbol
