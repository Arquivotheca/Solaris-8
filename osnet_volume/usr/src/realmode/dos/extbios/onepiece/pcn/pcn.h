...
#define MD3_RTRY    (1<<10)
#define MD3_LCAR    (1<<11)
#define MD3_LCOL    (1<<12)
#define MD3_UFLO    (1<<14)
#define MD3_TXBUFF  (1<<15)
...
/*
 * Local PIC definitions for PIC tinkering
 */
#define PIC_MASK_IRQ_ON(n)	(~(1<<(n)))
#define PIC_IMR_1		(0x21)
#define PIC_IMR_2		(0xA1)
...
struct PCN_MsgDesc	rx_ring[PCN_RX_RING_SIZE];
struct PCN_MsgDesc	tx_ring[PCN_TX_RING_SIZE];
