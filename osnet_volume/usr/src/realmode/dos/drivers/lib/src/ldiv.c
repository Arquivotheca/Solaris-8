...
#ident "@(#)ldiv.c	1.2	97/03/10 SMI"
 
/*
 *  Minimal C library for Solars x86 real mode drivers, long divide:
 *
 ...
 *    especially useful for real mode drivers since they don't have access
