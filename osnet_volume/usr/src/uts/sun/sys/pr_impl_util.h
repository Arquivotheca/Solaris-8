/*
 * Copyright (c) 1987-1989,1997-1998 by Sun Microsystems, Inc.
 * All rights reserved.
 */
...
#pragma ident	"@(#)pr_impl_util.h	1.20	98/01/06 SMI"	/* SunOS 1.10 */
...
#ifndef SHORT_ALIGN
#define	SHORT_ALIGN	(!(defined(sparc) || defined(__sparc)))
#endif
...
#define	LITTLE_ENDIAN	(defined(i386) || defined(__i386))
#endif
