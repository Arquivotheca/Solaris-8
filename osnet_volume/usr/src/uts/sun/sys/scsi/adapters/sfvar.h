...
#pragma ident	"@(#)sfvar.h	1.14	99/10/13 SMI"
...
/*
 * Group 5 Commands (CDB range 0xA0 - 0xBF)
 */
#define	SCMD_GROUP5		0xA0

/*
 * Group 5 commands, All Devices
 */
#define	SCMD_REPORTLUN		0xA0
...
struct sf {
	...
	ndi_events_t		sf_events;
	struct	sf_stats	sf_stats;
	uchar_t		sf_hp_initted;	/* hotplugging initialized flag */
};
...
#define	SF_BSY_TIMEOUT		2
#define	SF_ABORT_TIMEOUT	5000000 	/* in usec */
