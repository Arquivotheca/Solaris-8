...
#pragma ident	"@(#)sbusmem.c	1.21	98/01/21 SMI"
...
static struct modldrv modldrv = {
	...
	"SBus memory driver v1.21", /* Name of module. */
...
#if !defined(lint)
static char sbusmem_initmsg[] = "sbusmem _init: sbusmem.c\t1.21\t98/01/21\n";
#endif
