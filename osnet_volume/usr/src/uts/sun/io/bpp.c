...
#pragma ident	"@(#)bpp.c	1.31	99/04/14 SMI"
...
#else	BPP_DEBUG
	"pport driver: bpp 1.31 99/04/14",	/* name of module  */
#endif	BPP_DEBUG
	&bpp_ops				/* *Drv_dev_ops		*/
};
...
bpp_strategy(register struct buf *bp)
{
	...
	u_int	start_address;		/* kernel virt. DVMA start address */
	...
	bpp_regs_p->dma_bcnt = (u_int)size;
