...
#pragma ident	"@(#)ghd.c	1.17	99/07/15 SMI"
...
clock_t ghd_tran_abort_timeout = 5;
clock_t ghd_tran_abort_lun_timeout = 5;
clock_t ghd_tran_reset_target_timeout = 5;
clock_t ghd_tran_reset_bus_timeout = 5;
...
ghd_register(char	*labelp,
		...
		int	(*timeout_func)(void *, gcmd_t *, gtgt_t *, gact_t),
		tmr_t	*tmrp,
		ddi_iblock_cookie_t iblock,
		int	chno)
{
