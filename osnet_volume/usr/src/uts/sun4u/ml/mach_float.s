...
#pragma	ident	"@(#)mach_float.s	1.25	99/10/21 SMI"
...
{}
	...
	nop
#else
	sra	%o1, 0, %o2		! lower half to o2 for panic message
	call	panic			! panic if no ftt
	srlx	%o1, 32, %o1		! move upper half of fsr to o1
#endif
fttok:
#endif  /* DEBUG */
...
cexec_err:
	...
	mov	%g1, %o1
#else
	srlx	%g1, 32, %o1		! move upper half of fsr to o1
	call	panic			! panic
	sra	%g1, 0, %o2		! lower half to o2 for panic message
#endif
fpok:
	mov	%l1, %o0		! saved *rp
