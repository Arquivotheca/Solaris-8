...
#ident	"@(#)ip_ocsum.s	1.9	97/09/28 SMI"
...
.do_ocsum_copyout:
	...
	stn	%i4, [THREAD_REG + T_LOFAULT]	! install new vector
	ld	[%i2], %i2

	cmp	%i1, 31		! less than 62 bytes?
	bl,a	.dohw_copyout	!   just do halfwords
	tst	%i1		! delay slot, test count
...
6:
	...
	stda	%l0, [%i3+32+0]%asi
	stda	%l2, [%i3+32+8]%asi
	stda	%l4, [%i3+32+16]%asi
	stda	%l6, [%i3+32+24]%asi
	addxcc	%i2, %l7, %i2
5:
	ld	[%i0+64+0], %l0
	ld	[%i0+64+4], %l1
	...
	stda	%l0, [%i3+64+0]%asi
	stda	%l2, [%i3+64+8]%asi
	stda	%l4, [%i3+64+16]%asi
	stda	%l6, [%i3+64+24]%asi
	addxcc	%i2, %l7, %i2
6:
	ld	[%i0+96+0], %l0
	ld	[%i0+96+4], %l1
	...
	stda	%l0, [%i3+96+0]%asi
	stda	%l2, [%i3+96+8]%asi
	stda	%l4, [%i3+96+16]%asi
	stda	%l6, [%i3+96+24]%asi
	addxcc	%i2, %l7, %i2
#endif
...
.do_ocsum_copy:
	...
	cmp	%i1, 31		! less than 62 bytes?
	bl,a	.dohw_copyin	!   just do halfwords
	tst	%i1		! delay slot, test count
...
#define ldd2st
	...
	ldda	[%i0+32+0]%asi, %l0
	ldda	[%i0+32+8]%asi, %l2
	ldda	[%i0+32+16]%asi, %l4
	ldda	[%i0+32+24]%asi, %l6
	st	%l0, [%i3+32+0]
	addxcc	%i2, %l0, %i2
	st	%l1, [%i3+32+4]
	addxcc	%i2, %l1, %i2
...
5:
	ldda	[%i0+64+0]%asi, %l0
	ldda	[%i0+64+8]%asi, %l2
	ldda	[%i0+64+16]%asi, %l4
	ldda	[%i0+64+24]%asi, %l6
	st	%l0, [%i3+64+0]
	addxcc	%i2, %l0, %i2
	st	%l1, [%i3+64+4]
	addxcc	%i2, %l1, %i2
...
6:
	ldda	[%i0+96+0]%asi, %l0
	ldda	[%i0+96+8]%asi, %l2
	ldda	[%i0+96+16]%asi, %l4
	ldda	[%i0+96+24]%asi, %l6
	st	%l0, [%i3+96+0]
	addxcc	%i2, %l0, %i2
	st	%l1, [%i3+96+4]
	addxcc	%i2, %l1, %i2
