...
#pragma ident	"@(#)glmreg.h	1.6	99/04/19 SMI"
...
/*
 * Device ids mapped from PCI device id.
 */
#define	GLM_53c810	1
#define	GLM_53c810A	2
#define	GLM_53c815	3
#define	GLM_53c820	4
#define	GLM_53c825	5
#define	GLM_53c825A	6
#define	GLM_53c860	7
#define	GLM_53c875	8
#define	GLM_53c895	9
...
#define	DEFAULT_ULTRA_SYNC_PERIOD	50	/* 20.0 MB/s */
#define	DEFAULT_ULTRA2_SYNC_PERIOD	25	/* 40.0 MB/s */

/*
 * SDTR sync period responses.
 * Only used for Ultra and Ultra2.
 */

#define	SDTR_ULTRA_SYNC_PERIOD		12
#define	SDTR_ULTRA2_SYNC_PERIOD		10
...
#define	MAX_SYNC_PERIOD(glm) \
	((glm->g_speriod * MAX_CLOCK_DIVISOR * MAX_TP) / 100)
#define	MIN_SYNC_PERIOD(glm) \
	((glm->g_speriod * MIN_CLOCK_DIVISOR * MIN_TP) / 100)
...
#define	NB_SCNTL3_ULTRA		0x80	/* UltraSCSI Enabled. */
...
#define	NB_STEST1_DBLEN		0x08	/* SCLK Multiplier Enable */
#define	NB_STEST1_DBLSEL	0x04	/* SCLK Multiplier Select */

#define	NB_STEST2_EXT		0x02	/* extend SREQ/SACK filtering */
#define	NB_STEST2_ROF		0x40	/* Reset SCSI Offset */
#define	NB_STEST2_DIF		0x20    /* SCSI Differential Mode */
