...
#pragma ident	"@(#)ses_ses.c	1.14	99/09/21 SMI"
/*
 ...
 */
#define	SCSZ	0x4cc
#define	CFLEN	(SENSE_LENGTH < (256 + SES_ENCHDR_MINLEN))? \
	(256 + SES_ENCHDR_MINLEN) : SENSE_LENGTH
...
ses_getconfig(ses_softc_t *ssc)
{
	...
	SES_LOG(ssc, SES_CE_DEBUG3, "GenCode %x %d Subenclosures",
