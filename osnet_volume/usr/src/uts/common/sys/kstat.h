...
#pragma ident	"@(#)kstat.h	1.15	99/07/26 SMI"
 ...
 * 32-bit compilation environment (cc -Xc).  The visibility of i64 and ui64
 * is only permitted for 64-bit compilation environments or 32-bit non-
 * maximally conformant ANSI C compilation environments (cc -Xt and cc -Xa).
 */
