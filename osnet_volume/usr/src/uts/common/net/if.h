...
#pragma ident	"@(#)if.h	1.20	99/11/07 SMI"
...
#define	IFF_MULTI_BCAST	0x00001000	/* multicast using broadcast address */
#define	IFF_UNNUMBERED	0x00002000	/* non-unique address */
#define	IFF_DHCPRUNNING	0x00004000	/* DHCP controls this interface */
#define	IFF_PRIVATE	0x00008000	/* do not advertise */

/*
 * The following flags can't be grabbed or altered by SIOC[GS]IFFLAGS.
 * Should use SIOC[GS]LIFADDR which has a larger flags field.
 */
#define	IFF_NOXMIT	0x00010000	/* Do not transmit packets */
#define	IFF_NOLOCAL	0x00020000	/* No address - just on-link subnet */
#define	IFF_DEPRECATED	0x00040000	/* interface address deprecated */
#define	IFF_ADDRCONF	0x00080000	/* address from stateless addrconf */

#define	IFF_ROUTER	0x00100000	/* router on this interface */
#define	IFF_NONUD	0x00200000	/* No NUD on this interface */
...
#define	IFF_MIPRUNNING	0x04000000	/* Mobile IP controls this interface */
