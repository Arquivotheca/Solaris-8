...
#pragma ident	"@(#)krb5.h	1.2	99/08/31 SMI"
...
/* to keep lint happy */
#ifdef _KERNEL
#define krb5_xfree_wrap(val,n) kmem_free((char FAR *)(val),n)
#else
#define krb5_xfree_wrap(val,n) free((char FAR *)(val))
...
#define	KRB5_CONF_NOT_CONFIGURED		(-1765328157L)
