...
#pragma ident	"@(#)nfs_log.h	1.27	99/09/02 SMI"
...
typedef struct nfslog_buffer_header nfslog_buffer_header;
...
struct nfslog_record_header {
	...
	uint32_t rh_prognum;		/* Program number */
	uint32_t rh_procnum;		/* Procedure number */
	uint32_t rh_version;		/* Version number */
