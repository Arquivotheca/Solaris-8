...
#pragma ident	"@(#)ipsecahddi.c	1.7	99/10/21 SMI"
...
#define	D_SD_COMMENT "IP Authentication Header Streams device"
#define	D_SD_INFO ipsecahinfo
#define	D_SD_NAME "ipsecah"
#define	D_SD_OPS_NAME ipsecah_ops
/*
 * D_SD_FLAGS have to match D_SD_FLAGS in ipddi.c since this driver is
 * effectively a clone of the ip driver with the ipsecah module autopushed.
 */
#define	D_SD_FLAGS (D_MP|D_MTPERMOD|D_MTPUTSHARED|_D_MTOCSHARED| \
    _D_QNEXTLESS|_D_MTCBSHARED)
#define	D_SM_COMMENT "IP Authentication Header Streams module"
#define	D_SM_INFO ipsecahinfo
#define	D_SM_NAME "ipsecah"
#define	D_SM_OPS_NAME ipsecah_mops
