...
#pragma ident	"@(#)optcom.c	1.37	99/10/21 SMI"
...
static void do_opt_check_or_negotiate(queue_t *, struct T_opthdr *,
    uint_t, uchar_t **, t_uscalar_t *, int, optdb_obj_t *);
 ...
 *
 * tpi_optcom_buf(q, mp, opt_lenp, opt_offset, priv, dbobjp, thisdg_attrs,
 *	*is_absreq_failurep)
 *
