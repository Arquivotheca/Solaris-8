...
#pragma ident	"@(#)udp6ddi.c	1.3	99/10/21 SMI"
...
#define	D_SM_NAME "udp6"
#define	D_SM_OPS_NAME udp_mops
#define	D_SM_FLAGS (D_MP|D_MTQPAIR|D_MTPUTSHARED|_D_MTOCSHARED \
		|_D_QNEXTLESS)
...
_mi_driver_attach(dev_info_t *devi, ddi_attach_cmd_t cmd)
{
	...
	/* create with minor of 1 so that ip can tell it's IPv6 */
