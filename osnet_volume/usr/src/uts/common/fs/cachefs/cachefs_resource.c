 ...
 * All rights reserved.
 */
#pragma ident "@(#)cachefs_resource.c   1.82     99/11/07 SMI"
...
/* forward references */
int cachefs_rl_entry_get(cachefscache_t *, u_int, rl_entry_t **);
...
int
cachefs_rl_entry_get(cachefscache_t *cachep, u_int entno, rl_entry_t **ent)
{
	rl_entry_t *rl_ent;
