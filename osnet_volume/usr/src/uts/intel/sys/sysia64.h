...
#ifndef _SYS_SYSIA64_H
#define	_SYS_SYSIA64_H

#pragma ident	"@(#)sysia64.h	1.1	99/05/04 SMI"
...
/*
 * Commands for sysia64 system call (1-?)
 */
...
/*
 *  The SI86DSCR subcommand of the sysia64() system call
...
/*
 *  The SI86SHFIL subcommand of the sysia64() system call
...
/*
 *  The SI86PCHRGN subcommand of the sysia64() system call
...
/*
 * The SI86BADVISE subcommand of the sysia64() system call specifies
 * XENIX variant behavior for certain system calls and kernel routines.
 * The 'arg' argument of sysia64() for SI86BADVISE is an integer.  Bits
 ...
 *   (/bin/x286emul) in conjunction with the SI86SHRGN subcommand of sysia64().
 *   The SI86SHRGN subcommand is used by the XENIX 286 emulator to support
 *   XENIX shared data.  The second argument passed to sysia64() is a
 ...
 *   be returned in the 'xsd_size' field by sysia64().
 */
