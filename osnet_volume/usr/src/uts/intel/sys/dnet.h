...
#pragma ident	"@(#)dnet.h	1.20	99/07/14 SMI"
...
#define	MII_WRITE		((ulong_t)(0x00002000))
#define	MII_CLOCK		((ulong_t)(0x00010000))
#define	MII_WRITE_DATA		((ulong_t)(0x00020000))
#define	MII_DATA_IN		((ulong_t)(0x00080000))
...
#define	MII_PRE			((ulong_t)(0xFFFFFFFF))
#define	MII_READ_FRAME		((ulong_t)(0x60000000))
#define	MII_WRITE_FRAME		((ulong_t)(0x50020000))
#define	MII_READ		((ulong_t)(0x00044000))
#define	MII_WRITE_TS		((ulong_t)(0x00042000))
...
typedef struct leaf_format {
	ushort_t device_number;
	ushort_t gpr;
	ushort_t selected_contype;
	int block_count;
...
struct dnetinstance {
	...
	uchar_t 		*setup_buf_vaddr; /* setup buffer (virt) */
	...
	mblk_t			**tx_msgbufp;	/* streams message buffers */
						/* used for xmit */
	uchar_t			**rx_buf_vaddr;	/* recv buf addresses (virt) */
#endif
	...
	ulong_t			disallowed_media;
	int			disable_scrambler;
	int			overrun_workaround;
	int			interrupts_disabled;
	int			mii_up;
	ulong_t			gprsia; /* Write-through for 143's gprsia reg */
...
struct rx_desc_type {
	...
	volatile paddr_t	buffer1;
	volatile paddr_t	buffer2;
};
