...
#ifndef _IA32_SYS_FS_XMEM_H
#define	_IA32_SYS_FS_XMEM_H

#pragma ident	"@(#)xmem.h	1.2	99/06/15 SMI"
...
#define	xn_vcode	xn_attr.va_vcode
...
#define	XNTOV(xp)		((struct vnode *)&(xp)->xn_vnode)
...
extern	int	xmem_xaccess(struct xmemnode *, int, struct cred *);
