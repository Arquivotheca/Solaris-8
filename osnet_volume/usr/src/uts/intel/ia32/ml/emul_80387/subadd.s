...
#pragma ident	"@(#)subadd.s	1.2	99/05/04 SMI"
...
/	extrn	SR_MASKS,SR_FLAGS,SR_ERRORS
/a_msr	ends
/
/	assume	%ds:a_msr
...
compar:	/proc
	...
	orb	invalid_mask+zero_mask,SR_ERRORS/ clears zf, to 0
...
ordered_cases:
	...
	jz	operands_equal
	andb	$ -1 ! [zero_mask+sign_mask],SR_FLAGS / set zero to false
...
d_error_also:
	movb	true, signal_d_error_
set_uncertain:
	orb	$[sign_mask + c_mask], SR_FLAGS
	jmp	zero_true	/ set zero to true
operands_equal:
	andb	$-1 ! sign_mask,SR_FLAGS	/ set sign positive
zero_true:
