...
#pragma ident	"@(#)routed.h	1.8	98/01/06 SMI"	/* SVr4.0 1.1	*/
...
struct rip {
	uchar_t	rip_cmd;		/* request/response */
	uchar_t	rip_vers;		/* protocol version # */
	uchar_t	rip_res1[2];		/* pad to 32-bit boundary */
	union {
