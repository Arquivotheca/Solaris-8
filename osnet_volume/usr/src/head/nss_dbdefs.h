...
#pragma ident	"@(#)nss_dbdefs.h	1.30	99/08/19 SMI"
...
#define	NSS_DEFCONF_PRINTERS	"user files nis nisplus xfn"
...
#define	NSS_LINELEN_HOSTS	((NSS_BUFSIZ) * 2)
#define	NSS_LINELEN_IPNODES	((NSS_BUFSIZ) * 2)
