...
#pragma ident	"@(#)table.h	1.6	92/07/14 SMI"	/* SVr4.0 1.2	*/
 ...
 *	RETURN CODES
 */
#define	TLSUBSTITUTION	-11	/* Text to be used in a field contains one */
				/* or more field separatiors, end-of-entry */
				/* characters, or comment characters */
...
#define	TLFAILED	-1
#define	TLOK		0
#define	TLBADFS		1	/* Field Separator in TLopen() call differs */
				/* from that in the table */
